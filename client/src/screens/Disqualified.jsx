      ...
      <div className="flex-1 px-4 flex flex-col items-center gap-5 pt-10">
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          >
            ...
            {t.disqualified.shareWA.english}
          </motion.button>
          ...
          >
            ...
            {t.disqualified.shareSMS.english}
          </motion.button>
          ...
          >
            {copied ? (
              <>
                ...
                <span style={{ color: '#16A34A' }}>{t.disqualified.copied.english}</span>
              </>
            ) : (
              <>
                ...
                {t.disqualified.copyLink.english}
              </>
            )}
          </motion.button>
