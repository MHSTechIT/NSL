        ...
        {showSuccess && (
          <>
            ...
            <motion.div
              ...
              style={{ position: 'fixed', inset: 0, zIndex: 60, backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', background: 'rgba(180,160,255,0.15)' }}
            />
            ...
            <motion.div
              ...
              style={{
                position: 'fixed', bottom: 0, left: 16, right: 16,
            ...
            >
              {/* Drag handle */}
              <div style={{ width: 40, height: 4, borderRadius: 2, background: 'rgba(91,33,182,0.25)', margin: '0 auto 20px' }} />
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, marginBottom: 20 }}>
                ...
                />
                <span style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.70rem', fontWeight: 700, color: '#2d0a6e', letterSpacing: '0.10em', textTransform: 'uppercase' }}>
              ...
              {/* Heading */}
              <h2 style={{ fontFamily: '"Montserrat", Outfit, sans-serif', fontWeight: 900, fontSize: '1.1rem', color: '#2d0a6e', textAlign: 'center', marginBottom: 8, lineHeight: 1.2, whiteSpace: 'nowrap' }}>
                Join the <span style={{ color: '#15803d' }}>WhatsApp Group</span>
              </h2>
              <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.82rem', color: '#5b3fa0', textAlign: 'center', marginBottom: 20, lineHeight: 1.5 }}>
                All workshop <strong style={{ color: '#2d0a6e' }}>bonuses</strong> and the <strong style={{ color: '#2d0a6e' }}>joining link</strong> will be sent inside the WhatsApp group
              </p>
